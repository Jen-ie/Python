# -*- coding: utf-8 -*-
"""
Created on Sun Oct  9 13:05:12 2022
...
#         # If this did not work, return False return False
...
else: print(f"This module is called {__name__} and is being called by another script")

# if create_directory("Jen"): 
...
if create_directory("Jen") == 0: 
    print("Creating a directory worked") 
    # Do other stuff 
elif create_directory("Jen") == 1: 
    print("You couldn't create a directory!") 
    # Do other stuff 
elif create_directory("Jen") == 2: 
